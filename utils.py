...
def plot_mesh(myMesh,cmap=None):
    mp.plot(myMesh.vert, myMesh.face,c=cmap, filename="mymesh")
    
def double_plot(myMesh1,myMesh2,cmap1=None,cmap2=None):
    # d = mp.subplot(myMesh1.vert, myMesh1.face, c=cmap1, s=[2, 2, 0])
    mp.plot(myMesh1.vert, myMesh1.face,c=cmap1, filename="first")
    # d2 = mp.subplot(myMesh2.vert, myMesh2.face, c=cmap2, s=[2, 2, 1], data=d)
    mp.plot(myMesh2.vert, myMesh2.face,c=cmap2, filename="second")
    # d2.save("double")
